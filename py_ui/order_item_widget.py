...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.amount_item = QtWidgets.QLabel(parent=Form)
        self.amount_item.setObjectName("amount_item")
        self.horizontalLayout.addWidget(self.amount_item)
    ...
    def retranslateUi(self, Form):
        ...
        self.amount_item.setText(_translate("Form", "TextLabel"))
